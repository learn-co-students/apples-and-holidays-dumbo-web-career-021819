...
def add_supply_to_winter_holidays(holiday_hash, supply)
  ...
  holiday_hash.each do |season, holidays|
   holidays.each do |holiday_name, supplies|
    if holiday_name == :new_years || holiday_name == :christmas
    supplies << supply
    end
   end
  end
...
def all_holidays_with_bbq(holiday_hash)
  ...
  hol_array = []
  holiday_hash.collect do |season, seasonal_holidays|
    seasonal_holidays.each do |holiday, supply_array|
